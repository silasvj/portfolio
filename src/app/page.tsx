...
export default function Home() {
  ...
  const pathname = Link.toString(); // Placeholder to check if we can get lang, but we usually use usePathname
  // Actually, I'll use d to check language if possible or just use a simple check
  const isEn = d.nav.about === "About";
      ...
      <section id="projetos" className="py-24 bg-[#10101a] border-t border-[rgba(124,111,255,0.18)]">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { n: isEn ? "Phase 1" : "Fase 1", t: d.phases.phase1, d: d.phases.phase1Desc },
              { n: isEn ? "Phase 2" : "Fase 2", t: d.phases.phase2, d: d.phases.phase2Desc },
              { n: isEn ? "Phase 3" : "Fase 3", t: d.phases.phase3, d: d.phases.phase3Desc },
              { n: isEn ? "Phase 4" : "Fase 4", t: d.phases.phase4, d: d.phases.phase4Desc },
              { n: isEn ? "Phase 5" : "Fase 5", t: d.phases.phase5, d: d.phases.phase5Desc },
              { n: isEn ? "Phase 6" : "Fase 6", t: d.phases.phase6, d: d.phases.phase6Desc },
            ].map((phase, idx) => (

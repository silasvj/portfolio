...
const experienceData = [
  ...
  },
  {
    ...
    bullets: [
      "Atuação em duas squads simultâneas: desenvolvimento de novos produtos de saúde digital (app mobile) e melhoria do sistema de atendimento para call center.",
      "Condução de Discovery, entrevistas com stakeholders e operadores, e definição de requisitos.",
      "Projeto de UI, prototipação e aplicação de testes de usabilidade.",
    ],
    results: "+22% de atendimentos de orçamentos, 15 mil agendamentos mensais, lançamento de produto digital focado em saúde mental.",
  },
];
